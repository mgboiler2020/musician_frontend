    ...
    <div>
      ...
      <div className='App'>
        <div className='createBandForm'>
          ...
          <p>(Enter your band info below)</p>
          <form onSubmit={props.createBand}>
            <input name='bandName' type='text' placeholder='band name' onChange={props.loginOnChange} /><br></br>
            <input name='showDates' type='text' placeholder='show dates' onChange={props.loginOnChange} /><br></br>
            <input name='location' type='text' placeholder='show location' onChange={props.loginOnChange} /><br></br>
